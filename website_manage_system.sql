...
CREATE TABLE `application`  (
  ...
  `application_department_director` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '部门负责人工号',
  `application_office_phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '办公电话',
  `application_website_director_num` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '网站负责人工号',
  ...
  `application_submit_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '申请提交日期',
  `application_state` int(3) UNSIGNED NOT NULL DEFAULT 20 COMMENT '申请状态：20提交后审核，申请人只读取；30审核未通过 ，申请人可修改和重新提交；40审核通过，申请人只读',
...
CREATE TABLE `count`  (
  ...
  `count_bug_total` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE `department`  (
  ...
  `department_director` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '部门负责人工号',
...
CREATE TABLE `log`  (
  ...
  `log_job_num` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户工号',
  ...
  `log_create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '日志创建时间',
...
CREATE TABLE `message`  (
  ...
  `message_sender` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '发送者工号',
  `message_receiver` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '接收者工号',
...
CREATE TABLE `user`  (
  ...
  `user_job_num` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户工号',
...
CREATE TABLE `website`  (
  ...
  `website_director_num` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '网站负责人工号',
  ...
  `website_notice_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '1 SQL注入攻击；2：XSS攻击；3：CSRF攻击；4：文件上传漏洞；5：访问控制；6：其他',
